...
Wearable Computing is a new and upcoming field of technology. This generates a variety of data that must be cleaned before it can be used. In this project, data collected from the accelerometer and gyroscope of the Samsung Galaxy S smartphone was retrieved, worked with, and cleaned, to prepare a tidy data that can be used for later analysis.
...
The `tidy_data.txt` in this repository was created by running the `run_analysis.R` script using R version 3.5.1 on Windows 7 64-bit edition.
